...
@section('title', 'Réseau Social Laravel - Mon compte')

@section('content')
    <div class="container mx-auto px-4 py-8">
        <h1 class="text-3xl font-bold text-white mb-4">Mon compte</h1>
        <h3 class="text-xl font-semibold pb-3 text-center text-white">Modifier mes informations</h3>
        ...
        <div class="flex justify-center"><form action="{{ route('users.destroy', $user) }}" method="POST" class="mt-6">
                @csrf
                @method('DELETE')
